...
export default function Dashboard() {
  ...
  const cards = [
    ...
    { title: 'Average Workload', value: `${stats.average_workload}%`, icon: Activity, color: 'bg-purple-500' },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6 border border-gray-100">
        <h3 className="text-lg font-medium text-gray-800 mb-4">Welcome to AI Workforce Agent</h3>
